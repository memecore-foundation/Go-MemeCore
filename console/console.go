...
// Welcome show summary of current Gmeme instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the Gmeme JavaScript console!\n\n"

	// Print some generic Gmeme metadata
