...
var Defaults = Config{
	...
	LogHistory:         2350000,
	BlockHistory:       0, // The maximum number of blocks from head whose data are reserved. 0 = entire chain.
...
type Config struct {
	...
	// canonical chain of all remote peers. Setting the option makes gmeme verify the
