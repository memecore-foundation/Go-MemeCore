...
func TestConsoleWelcome(t *testing.T) {
	...
	gmeme.SetTemplateFunc("gmemever", func() string { return params.VersionWithCommit("", "") })
...
func testAttachWelcome(t *testing.T, gmeme *testgmeme, endpoint, apis string) {
	...
	attach.SetTemplateFunc("gmemever", func() string { return params.VersionWithCommit("", "") })
	attach.SetTemplateFunc("etherbase", func() string { return gmeme.Etherbase })
