		...
		Subcommands: []*cli.Command{
			{
				...
				Description: `
gmeme snapshot prune-state <state-root>
...
`,
			},
			{
				...
				Description: `
gmeme snapshot verify-state <state-root>
...
`,
			},
			{
				...
				Flags:     slices.Concat(utils.NetworkFlags, utils.DatabaseFlags),
				Description: `
gmeme snapshot check-dangling-storage <state-root> traverses the snap storage
...
`,
			},
			{
				...
				Flags:     slices.Concat(utils.NetworkFlags, utils.DatabaseFlags),
				Description: `
gmeme snapshot inspect-account <address | hash> checks all snapshot layers and prints out
...
`,
			},
			{
				...
				Flags:     slices.Concat(utils.NetworkFlags, utils.DatabaseFlags),
				Description: `
gmeme snapshot traverse-state <state-root>
...
`,
			},
			{
				...
				Flags:     slices.Concat(utils.NetworkFlags, utils.DatabaseFlags),
				Description: `
gmeme snapshot traverse-rawstate <state-root>
...
`,
			...
			{
				Name:      "dump",
				Usage:     "Dump a specific block from storage (same as 'gmeme dump' but using snapshots)",
				...
				Description: `
This command is semantically equivalent to 'gmeme dump', but uses the snapshots
