...
// TestAttachWithHeaders tests that 'gmeme attach' with custom headers works, i.e
...
// TestRemoteDbWithHeaders tests that 'gmeme db --remotedb' with custom headers works, i.e
// that custom headers are forwarded to the target.
...
func testReceiveHeaders(t *testing.T, ln net.Listener, gmemeArgs ...string) {
