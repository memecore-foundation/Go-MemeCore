...
var app = flags.NewApp("go-memecore era tool")
...
func block(ctx *cli.Context) error {
	...
	val := ethapi.RPCMarshalBlock(block, ctx.Bool(txsFlag.Name), ctx.Bool(txsFlag.Name), params.MemeCoreMainnetChainConfig)
